    ...
    <MainLayout>
      <div>
        <div className="flex items-center justify-center mr-0 lg:mr-8 my-8 w-full">
          ...
          <div className="w-[70%] mx-0 lg:mx-[5rem] ml-0 lg:ml-8 flex flex-col gap-6">
            <p className="font-[500] text-3xl leading-7">Inscríbete en la Chaos Series</p>
            <p className="font-[400] text-xl leading-7 w-auto lg:w-[50rem]">Forma parte de la liga para unirte y conocer a nuevos jugadores, equipos y staff en un ambiente sano y perfecto para comenzar y mejorar tu carrera como jugador.</p>
